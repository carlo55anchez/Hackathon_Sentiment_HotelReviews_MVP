...
Este README.md documenta la evolución del modelo hacia un sistema más justo, sensible a las críticas y con una arquitectura de despliegue moderna basada en contenedores.
